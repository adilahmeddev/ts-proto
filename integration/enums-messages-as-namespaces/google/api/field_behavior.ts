...
export type FieldBehavior = typeof FieldBehavior[keyof typeof FieldBehavior];

export namespace FieldBehavior {
  export type FIELD_BEHAVIOR_UNSPECIFIED = typeof FieldBehavior.FIELD_BEHAVIOR_UNSPECIFIED;
  export type OPTIONAL = typeof FieldBehavior.OPTIONAL;
  export type REQUIRED = typeof FieldBehavior.REQUIRED;
  export type OUTPUT_ONLY = typeof FieldBehavior.OUTPUT_ONLY;
  export type INPUT_ONLY = typeof FieldBehavior.INPUT_ONLY;
  export type IMMUTABLE = typeof FieldBehavior.IMMUTABLE;
  export type UNORDERED_LIST = typeof FieldBehavior.UNORDERED_LIST;
  export type NON_EMPTY_DEFAULT = typeof FieldBehavior.NON_EMPTY_DEFAULT;
  export type IDENTIFIER = typeof FieldBehavior.IDENTIFIER;
  export type UNRECOGNIZED = typeof FieldBehavior.UNRECOGNIZED;
}
